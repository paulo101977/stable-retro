...
static const x32& getFlagReg(uint fInst)
{
...
void setBitSFLAG(const x32& reg, const x32& regT, int bitTest, int bitSet)
{
	xTEST(regT, bitTest);
	xForwardJZ8 skip;
	xOR(reg, bitSet);
...
void setBitFSEQ(const x32& reg, int bitX)
{
	xTEST(reg, bitX);
...
void mVUallocSFLAGa(const x32& reg, int fInstance)
{
	xMOV(reg, getFlagReg(fInstance));
}

// __fi void mVUallocSFLAGb(const x32& reg, int fInstance)
void mVUallocSFLAGb(const x32& reg, int fInstance)
{
...
void mVUallocSFLAGc(const x32& reg, const x32& regT, int fInstance)
{
	xXOR(reg, reg);
...
void mVUallocSFLAGd(u32* memAddr, const x32& reg = eax, const x32& tmp1 = ecx, const x32& tmp2 = edx)
{
...
void mVUallocMFLAGa(mV, const x32& reg, int fInstance)
{
	xMOVZX(reg, ptr16[&mVU.macFlag[fInstance]]);
}

// __fi void mVUallocMFLAGb(mV, const x32& reg, int fInstance)
void mVUallocMFLAGb(mV, const x32& reg, int fInstance)
{
	//xAND(reg, 0xffff);
...
void mVUallocCFLAGa(mV, const x32& reg, int fInstance)
{
...
void mVUallocCFLAGb(mV, const x32& reg, int fInstance)
{
